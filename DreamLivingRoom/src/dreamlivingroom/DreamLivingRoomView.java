...
public class DreamLivingRoomView extends FrameView {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = DreamLivingRoomApp.getApplication().getMainFrame();
            aboutBox = new DreamLivingRoomAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        DreamLivingRoomApp.getApplication().show(aboutBox);
    }
